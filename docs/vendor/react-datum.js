...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_input_autosize__ = __webpack_require__(41);
...
var _ReactDatum = {
  ...
  ClickToEditForm: __webpack_require__(21),
  ContextualData: __webpack_require__(7),
  Collection: __webpack_require__(26),
  CollectionStats: __webpack_require__(29),
  Form: __webpack_require__(15),
  Model: __webpack_require__(30),
  SelectedModel: __webpack_require__(31),

  // Datums
  Datum: __webpack_require__(2),
  Email: __webpack_require__(32),
  LazyPhoto: __webpack_require__(33),
  Link: __webpack_require__(34),
  Number: __webpack_require__(13),
  Percent: __webpack_require__(35),
  Text: __webpack_require__(16),
  Label: __webpack_require__(36),
  WholeNumber: __webpack_require__(37),
  ...
  CollectionPicker: __webpack_require__(38),
  // react-select 
  ReactSelect: __webpack_require__(17),
  SelectOption: __webpack_require__(42)

};
if (window) window.ReactDatum = _ReactDatum;

var ClickToEditForm = _ReactDatum.ClickToEditForm,
    ContextualData = _ReactDatum.ContextualData,
    Collection = _ReactDatum.Collection,
    CollectionPicker = _ReactDatum.CollectionPicker,
    CollectionStats = _ReactDatum.CollectionStats,
    Form = _ReactDatum.Form,
    Model = _ReactDatum.Model,
    SelectedModel = _ReactDatum.SelectedModel,
    Datum = _ReactDatum.Datum,
    Email = _ReactDatum.Email,
    LazyPhoto = _ReactDatum.LazyPhoto,
    Link = _ReactDatum.Link,
    Number = _ReactDatum.Number,
    Percent = _ReactDatum.Percent,
    Text = _ReactDatum.Text,
    Label = _ReactDatum.Label,
    WholeNumber = _ReactDatum.WholeNumber,
    Options = _ReactDatum.Options,
    ReactSelect = _ReactDatum.ReactSelect,
    SelectOption = _ReactDatum.SelectOption;
exports.ClickToEditForm = ClickToEditForm;
exports.ContextualData = ContextualData;
exports.Collection = Collection;
exports.CollectionPicker = CollectionPicker;
...
(function () {
  ...
  SelectableCollection = __webpack_require__(27);
...
(function () {
  ...
  Strhelp = __webpack_require__(39);
  ...
  module.exports = CollectionPicker = function (superClass) {
    ...
    CollectionPicker.prototype.renderInput = function () {
      if (this.props.synchronousLoading) {
        return React.createElement(Select["default"], React.__spread({}, this.getSelectOptions()));
      } else {
        return React.createElement(Select.Async, React.__spread({}, this.getSelectAsyncOptions()), function (_this) {
          return function (props) {
            ...
            props.ref = 'select';
            return React.createElement(Select["default"], React.__spread({}, props));
          };
        }(this));
      }
    };
...
var _blockEvent = __webpack_require__(43);
