	...
	var Select = _react2['default'].createClass({
		...
		addValue: function addValue(value) {
			...
			if (this.props.allowCreate) {
				this.setValue(valueArray.concat(this.expandValue(value)));
			} else {
	...
	var Select = _react2.default.createClass({
		...
		addRemoveValue: function addRemoveValue(valueObj) {
			...
			if (!this.arrayContains(valueArray, valueObj.value)) {
				if (this.props.allowCreate) {
					this.setValue(valueArray.concat(this.expandValue(valueObj.value)));
				} else this.setValue(valueArray.concat(valueObj));
			} else {
